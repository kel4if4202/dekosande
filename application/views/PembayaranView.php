    ...
    <div class="card p-5">
        ...
        <div class="pricing p-3 rounded mt-4 d-flex justify-content-between">
            <div class="images d-flex flex-row align-items-center"> 
                <div class="d-flex flex-column ml-4"> <span class="business">Small Business</span> </div>
            </div>
            <!--pricing table-->
        ...
        <div class="mt-3"> <button class="btn btn-primary btn-block payment-button" onclick=document.location.href="<?= site_url('Welcome/historyBooking') ?>">Proceed to payment <i class="fa fa-long-arrow-right"></i></button> </div>
    </div>
</div>